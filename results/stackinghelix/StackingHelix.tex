...
V0fromLNB[L_,NB_,delta_] :=
With[{k = Normalize[NB],
    theta = AngleWithXZ[NB],
    rt = RotationTransform[delta,{1,0,0}]},
  rt[NB]
  ]

AfromParam[v0_,tau_,NB_] :=
With[{k = Normalize[NB]},
  Print[N[k]];
  Print[tau];
  Print[N[v0]];
...
AfromLtauNBNC[L_,tau_,NB_,NC_] :=
With[{delta = VectorAngle[NC,{0,0,1}]},
    With[{v0 = V0fromLNB[L,NB,delta]},
        AfromParam[v0,tau,NB]]]
...
With[{
  ...
  (* Print[AfromLtauNBNC[L0,tau,NB0,NC0]]; *)
  AfromLtauNBNC[L0,tau,NB1,NC1]]]
